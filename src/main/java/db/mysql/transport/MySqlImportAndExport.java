...
//        String port = "3307";//使用的端口号
        String exportPath = properties.getProperty("jdbc.exportPath");//导出路径

        //注意哪些地方要空格，哪些不要空格

        command.append("C:\\Program Files\\MySQL\\MySQL Server 5.1\\bin\\mysqldump.exe -u").append(username).append(" -p").append(password)//密码是用的小p，而端口是用的大P。
