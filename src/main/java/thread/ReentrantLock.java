...
public class ReentrantLock implements Lock, java.io.Serializable {
    ...
    abstract static class Sync extends AbstractQueuedSynchronizer {
        ...
        protected final boolean tryRelease(int releases) {
            logger.info("tryRelease 尝试释放锁{}", Thread.currentThread().getId());
            int c = getState() - releases;//独占所getState 返回1，表示release之前有线程通过acquire拿到了锁
    ...
    /**
     * Creates an instance of {@code ReentrantLock2}.
     * This is equivalent to using {@code ReentrantLock2(false)}.
     */
    ...
    /**
     * Creates an instance of {@code ReentrantLock2} with the
     ...
     * <pre> {@code
     * class X {
     *   ReentrantLock22 lock = new ReentrantLock22();
     *   // ...
     *   public void m() {
     ...
     * <pre> {@code
     * class X {
     *   ReentrantLock22 lock = new ReentrantLock2();
     *   // ...
     *
     *   public void m() {
     *       assert !lock.isHeldByCurrentThread();
